...
#
# Created: Mon Dec 24 10:24:48 2018
...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        MeshGeneratorWidget.resize(1789, 1858)
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(441, 354))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 738, 1591))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.parameterSet_frame = QtGui.QFrame(self.scrollAreaWidgetContents_2)
        self.parameterSet_frame.setMinimumSize(QtCore.QSize(0, 0))
        self.parameterSet_frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.parameterSet_frame.setFrameShadow(QtGui.QFrame.Raised)
        self.parameterSet_frame.setObjectName("parameterSet_frame")
        self.formLayout = QtGui.QFormLayout(self.parameterSet_frame)
        self.formLayout.setContentsMargins(-1, 3, -1, -1)
        self.formLayout.setObjectName("formLayout")
        self.parameterSet_label = QtGui.QLabel(self.parameterSet_frame)
        self.parameterSet_label.setObjectName("parameterSet_label")
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.parameterSet_label)
        self.parameterSet_comboBox = QtGui.QComboBox(self.parameterSet_frame)
        self.parameterSet_comboBox.setObjectName("parameterSet_comboBox")
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.parameterSet_comboBox)
        self.verticalLayout_3.addWidget(self.parameterSet_frame)
