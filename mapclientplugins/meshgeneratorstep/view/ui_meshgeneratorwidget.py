...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        self.displayDataContours_checkBox = QtGui.QCheckBox(self.displayData_frame)
        ...
        self.displayDataMarkerPoints_checkBox = QtGui.QCheckBox(self.displayData_frame)
        self.displayDataMarkerPoints_checkBox.setObjectName("displayDataMarkerPoints_checkBox")
        self.horizontalLayout_9.addWidget(self.displayDataMarkerPoints_checkBox)
        self.displayDataMarkerNames_checkBox = QtGui.QCheckBox(self.displayData_frame)
        self.displayDataMarkerNames_checkBox.setObjectName("displayDataMarkerNames_checkBox")
        self.horizontalLayout_9.addWidget(self.displayDataMarkerNames_checkBox)
